...
class ControlLDM(LatentDiffusion):
    ...
    def get_input(self, batch, k, bs=None, *args, **kwargs):
        x, c = super().get_input(batch, self.first_stage_key, *args, **kwargs) # self.first_stage_key = 'jpg'
        _, lighting = super().get_input(batch, self.first_stage_key, cond_key='caption', *args, **kwargs) # add
        ...
        return x, dict(c_crossattn=[c], c_concat=[control], c_lighting = [lighting])
    ...
    def apply_model(self, x_noisy, t, cond, *args, **kwargs):
        ...
        cond_lighting = torch.cat(cond['c_lighting'], 1) # (Batch_size, 77, 768)
